...
PROFILS = {
    ...
    "lovekitchen": {"logo_marque": "logo de marque commerciale",
                    "mineur_visible": "mineur visible"},
    # Pisciniste : la source est un createur YouTube qui filme son propre
    # travail. Ce qui doit bloquer, c'est sa signature (nom de chaine, logo
    # d'entreprise sur un camion ou un polo) et tout mineur a l'image — on
    # filme des jardins prives. Le texte incruste n'est PAS bloquant ici :
    # nos propres sous-titres en sont, et un controle place apres eux
    # refuserait tout, piege deja paye trois fois sur ce projet.
    "pisciniste": {"watermark": "pseudo, URL ou filigrane d'un autre createur",
                   "logo_marque": "logo d'entreprise de piscine ou de marque",
                   "mineur_visible": "mineur visible"},
}
